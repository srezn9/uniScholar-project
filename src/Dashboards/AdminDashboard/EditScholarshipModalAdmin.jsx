...
const EditScholarshipModalAdmin = ({ scholarship, onClose, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded shadow-md w-full max-w-lg relative">
        <h2 className="text-xl font-bold mb-4">Edit Scholarship (Admin)</h2>
...
export default EditScholarshipModalAdmin;
