...
const UserDashboard = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-white via-accent/10 to-white">
      {/* Sidebar */}
      <aside className="w-full md:w-64 bg-gradient-to-b from-primary to-accent text-white p-5 md:p-6 shadow-lg md:min-h-screen">
